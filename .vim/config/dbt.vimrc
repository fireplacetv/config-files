...
au BufNewFile,BufRead *.sql set path+=*/macros/**
au BufNewFile,BufRead *.sql set path+=*/models/**

" yml and md are for opening files from dbt docs files
au BufNewFile,BufRead *.yml set path+=*/macros/**
au BufNewFile,BufRead *.yml set path+=*/models/**

au BufNewFile,BufRead *.md set path+=*/macros/**
au BufNewFile,BufRead *.md set path+=*/models/**
